...
exports.onCreateWebpackConfig = ({
  ...
  let {
    ...
    postCssPlugins
      ...
      postcssOptions = (0, _objectWithoutPropertiesLoose2.default)(_ref, ["cssLoaderOptions", "postCssPlugins"]);
  ...
  const postcssRule = {
    test: CSS_PATTERN,
    use: isSSR ? [loaders.null()] : [loaders.css(Object.assign({}, cssLoaderOptions, {
      importLoaders: 1
    })), postcssLoader]
  };
  const postcssRuleModules = {
    test: MODULE_CSS_PATTERN,
    use: [loaders.css(Object.assign({}, cssLoaderOptions, {
      importLoaders: 1,
      modules: true
    })), postcssLoader]
  };
