...
function NotFoundPage() {
  return (
    <Layout>
      ...
      <Nav />
      <div className="bg-white w-full h-full z-20 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 pt-12 pb-10 sm:pb-6 lg:pt-32 xl:pb-24 2xl:pt-56 2xl:pb-48">
        <div className="absolute left-0">
          <img className="-mt-24 -mb-12 -pl-4" src={patterns.headerRec} alt="" />
        </div>
        <div className="text-army-green-primary text-center py-32">
          ...
          <a
            href="/"
            className="w-1/2 block sm:inline-block sm:w-auto mt-8 px-12 py-3 bg-orange-primary text-black text-center uppercase"
          >
            Return Home
          </a>
        </div>
