...
import { hotels, patterns } from "../components/cloudImages";
    ...
    <section className="bg-white-smoke lg:flex-row px-4 lg:px-40 pt-12 lg:pt-24">
      <div className="flex flex-wrap">
        <div className="mb-8 lg:mb-12 w-full lg:w-1/2 text-dark-blue-primary-600">
          <h1 className="text-sec font-bold font-ubuntu">Hotels</h1>
          <p className="text-base">You can always stop by the following beautiful hotels</p>
        </div>
