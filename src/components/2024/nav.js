    ...
    <div className="container flex flex-row mx-auto justify-between p-5 w-screen">
      ...
      {isExpanded ? (
        <span className="fill-current h-4 w-8">
          <svg width="15" height="30" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg" class="bg-white p-6">
        ...
        <span className="fill-current h-9 w-9 flex flex-col items-center justify-center">
          <svg width="44" height="30" viewBox="0 0 44 55" fill="none" xmlns="http://www.w3.org/2000/svg" class="bg-white flex">
