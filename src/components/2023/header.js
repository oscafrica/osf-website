        ...
        >
          <div
            ...
            <a
              ...
              className="font-clashDisplay font-semibold bg-orange-400 text-brown uppercase p-3 text-l tracking-wider mb-4 mx-4 w-fit flex items-center shadow-md"
              target="_blank"
              rel="noreferrer"
            >
              Register &nbsp; | &nbsp;
              {/* TODO: change to down tick */}
              <span className="">
          ...
          <div className="z-10 flex flex-wrap items-center">
            <div className="w-full h-full mx-auto container text-white flex flex-col items-center">
              ...
              <div className="flex flex-col items-center">
                <a
                  href="/2022"
                  className="font-clashDisplay font-semibold bg-transparent text-white border-2 border-solid border-white-400 uppercase p-3 text-l tracking-wider mb-4 mx-4 w-fit flex items-center"
                >
                  View Past Events &nbsp; | &nbsp;
                  <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
