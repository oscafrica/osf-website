  ...
  return (
    <section id="header">
      <div className="center flex flex-col w-screen object-cover lg:pt-10">
        <div className="px-5 md:px-10 lg:px-0 flex flex-col z-30 left-0 w-full min-h-screen lg:pt-16 overflow-hidden" style={bgWrapperStyles}>
          <div className="container mt-10 lg:mt-20 mx-auto lg:px-14 flex justify-between sm:flex-row flex-col mb-6 lg:mb-10 lg:items-center">
            <h1 className="font-humane text-white text-4xl lg:text-6xl m-0 uppercase">OPEN SOURCE FESTIVAL 2023 + SUSTAIN</h1>
