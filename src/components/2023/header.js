      ...
      <div className="center flex flex-col w-screen object-cover pt-10">
        ...
        >
          <div
            ...
            <div className="font-clashDisplay font-semibold text-brown uppercase relative group">
              <button
              ...
              >
                ...
                <span className="hidden group-hover:block group-hover:transition duration-150 ease-in-out">
                  <svg width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="bg-white p-3 text-l tracking-wider shadow-md w-full absolute z-20 hidden group-hover:block transition duration-150 ease-in-out">
                <a
          ...
          <div className="z-10 flex flex-wrap items-center">
            <div className="w-full h-full mx-auto container text-white flex flex-col items-center">
              <div>
                <span className="w-[600px] h-[600px] z-10 absolute blur-[100px] left-[-48px] top-[477px]" style={{background: "radial-gradient(50% 50% at 50% 50%, rgba(255, 0, 26, 0.41) 0%, rgba(255, 2, 230, 0.27) 50.52%, rgba(212, 0, 255, 0) 100%)"}}></span>
