...
import {homeBackground, logo} from './cloudImages';
function Home() {
    return (
        <section id='home'>
                        ...
                        <div className='w-full md:w-full sm:mt-36 sm:m-auto sm:my-24 m-auto  text-white flex flex-col items-center'>
                            ...
                            <div>
                                <div className='flex xs:flex-col flex-row mt-5 xs:mb-16 md:mb-10 '>
                                    <a href='https://opencollective.com/osca/events/open-source-festival-2023-e17954c1' className='bg-orange-400 uppercase p-4 text-xl text-brown tracking-wider xs:mb-4 mx-4'>Become a Sponsor | ↗</a>
                                    <a href='#' className='bg-transparent uppercase p-4 text-white border-2 border-solid border-gray-500 tracking-wider text-xl mx-4'>Become a Speaker | ↗</a>
                                </div>
                                <div className='flex flex-col items-center'>
                                    <a href='/2022' className='uppercase p-2 text-white tracking-wider text-xl xs:my-10 my-10'>View Previous Events | ↗</a>
                                </div>
                            </div>
                        </div>
                    </div>
