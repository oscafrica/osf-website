  ...
  return (
    <div className="pagination">
      <button
        ...
        className={classNames([classes.paginationButton], { [classes.disabled]: isDisabled("left") })}
      ...
      <button
        ...
        className={classNames([classes.paginationButton], { [classes.disabled]: isDisabled("right") })}
        onClick={handleClick(currentPage + 1)}
      >
        &#10148;
      </button>
