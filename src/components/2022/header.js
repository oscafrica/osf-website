          ...
          <div className="w-full md:w-full sm:w-2/3 relative z-10 text-white">
            ...
            <div className="font-bold">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="font-anisette text-center text-xs w-full block sm:inline-block sm:w-auto xl:mb-0 md:mt-0 lg:mt-8 mr-5 px-12 py-6 mb-4 bg-orange-primary text-black uppercase hover:bg-inherit hover:outline hover:outline-orange-primary hover:outline-4 hover:text-white transition-colors duration-500"
              >
                Register
              </a>
              <a
