    ...
    <section className="bg-white-smoke lg:flex-row px-4 lg:px-40 pt-2">
      <div className="flex flex-wrap">
        <div className="w-full text-dark-blue-primary-600">
          <h1 className="text-2xl font-bold font-anisette">ACCOMMODATION</h1>
      ...
      <div className="relative my-12 text-center lg:text-right">
        <a
          ...
          className="p-6 bg-orange-primary text-dark uppercase hover:bg-inherit hover:outline hover:outline-orange-primary hover:text-orange-primary transition-colors duration-500"
          target="_blank"
